...
public class TestScript24 extends Base_Test{
	@Test(dataProvider = "testdata")
	public void testScript24(String email, String pwd) throws IOException, InterruptedException {
		 ...
		 /* welcomePage.clickRegister();
		  ...
		  booksPage.fictionExBookPage();
		  ProductPage productPage=new ProductPage(driver);
		  productPage.addToComparelistbutton();
		  homePage.booksButton();
		  booksPage.fictionExBookPage();
		  Thread.sleep(20000);
		  booksPage.twitterIcon();
